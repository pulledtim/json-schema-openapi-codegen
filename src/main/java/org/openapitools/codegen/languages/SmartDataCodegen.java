...
public class SmartDataCodegen extends AbstractJavaCodegen
    ...
    public void processOpts() {
        ...
        this.fieldRenames.putAll(Map.of("@type", "tmForumType", "@schemaLocation", "atSchemaLocation", "@baseType", "atBaseType"));
    }
    ...
    public Map<String, ModelsMap> updateAllModels(Map<String, ModelsMap> objs) {
        ...
        new SchemaGenerator(outputFolder(), schemaRegistry).writeSchemata(superObjs,fieldRenames);
